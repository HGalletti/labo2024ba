...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(
    202106, 202105, 202104, 202103, 202102, 202101, 202012,
    202011, 202010, 202009, 202008, 202007, 202006, 202005,
    202004, 202002, 202001, 201912, 201911, 201910,
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    lambda_l1 = c( 1, 1500 ), # lambda_l1 >= 0.0
    lambda_l2 = c( 1, 1500 ), # lambda_l2 >= 0.0
