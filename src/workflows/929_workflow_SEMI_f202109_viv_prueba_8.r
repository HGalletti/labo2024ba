...
# Con respecto a Prueba 4, cambiado RF y puesto 0.3 en undersampling de TS, colocados para optimizar lambda 1 y lambda 2, unbalance TRUE, subidas a 100 las iteraciones de BO. En la 6 cambiado desvio a 1 en CN. Quitado undersamplig, retocado meses TS
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$testing <- c(202105, 202107)
